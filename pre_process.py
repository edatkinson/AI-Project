...
source_dir = '/users/edatkinson/LLL/classes/Scissors/'
...
for split in ['train', 'validation', 'test']:
    split_dir = os.path.join(target_base_dir, split, 'Scissors')
...
copy_files(train_files, os.path.join(target_base_dir, 'train', 'Scissors'))
copy_files(val_files, os.path.join(target_base_dir, 'validation', 'Scissors'))
copy_files(test_files, os.path.join(target_base_dir, 'test', 'Scissors'))
