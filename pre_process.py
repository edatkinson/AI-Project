...
source_dir = '/users/edatkinson/LLL/classes/Null/'
...
for split in ['train', 'validation', 'test']:
    split_dir = os.path.join(target_base_dir, split, 'Null')
...
copy_files(train_files, os.path.join(target_base_dir, 'train', 'Null'))
copy_files(val_files, os.path.join(target_base_dir, 'validation', 'Null'))
copy_files(test_files, os.path.join(target_base_dir, 'test', 'Null'))
